...
const saidaEsperada1 = await Deno.readTextFile(`./saidas/saida1.txt`)
...
const saidaEsperada2 = await Deno.readTextFile(`./saidas/saida2.txt`)
...
const saidaEsperada3 = await Deno.readTextFile(`./saidas/saida3.txt`)
...
const saidaEsperada4 = await Deno.readTextFile(`./saidas/saida4.txt`)
...
const saidaEsperada5 = await Deno.readTextFile(`./saidas/saida5.txt`)
...
const saidaEsperada6 = await Deno.readTextFile(`./saidas/saida6.txt`)
...
const saidaEsperada7 = await Deno.readTextFile(`./saidas/saida7.txt`)
...
const saidaEsperada8 = await Deno.readTextFile(`./saidas/saida8.txt`)
...
const saidaEsperada9 = await Deno.readTextFile(`./saidas/saida9.txt`)
...
const saidaEsperada10 = await Deno.readTextFile(`./saidas/saida10.txt`)
...
const saidaEsperada11 = await Deno.readTextFile(`./saidas/saida11.txt`)
